...
Given A user books a flight from Poland/Warsaw to United Kingdom/London from 14-08-2016 to 20-08-2016 for two adults and one child
And Correctly provide the rest of the details up to the payment page
When The user provides invalid credit card number details, i.e. "5555555555554444", "5/2020" and "111"
And Clicks Pay Now
